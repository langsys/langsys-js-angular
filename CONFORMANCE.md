...
| Suite                       | **83 tests / 8 files**, all passing (includes the 5-test upstream precondition)                                                                 |
...
3. **v19 incremental hydration is not covered.** A `@defer (hydrate on viewport)` subtree branching
...
npm test                           # 83 tests, 8 files — includes the precondition
